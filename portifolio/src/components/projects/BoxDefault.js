...
function Econs({ title, tech, desc, print, alt }) {
    return (
        <div className={style.projeto}>
            <div className={`${style.projeto__content} ${style.container}`}>
                <div className={style.projeto__box}>
                    <div>
                        <img src={print} alt={alt} className={style.projeto__img_box} />
                    </div>
                    <div className={style.projeto__description}>
                        ...
                        <div className={style.projeto__description__btn_box}>
                            ...
                            <a href='https://github.com/israelsouza/ECONSciente' target='_blank' rel="noreferrer noopener" className={style.projeto__description__link}>
                            ...
                            <a href='https://israelsouza.github.io/ECONSciente/' target='_blank' rel="noreferrer noopener" className={style.projeto__description__link}>
                                <btn className={style.projeto__description__btn}>
                                    Site
                                </btn>
                            </a>
